    ...
    const fetchMock = vi
      ...
      .mockResolvedValueOnce({
        ...
        json: async () => [
          ...
          { name: "v1.23.1.preview" },
          { name: "v1.23.0.preview" },
  ...
  it("lists valid delivery tags from v1.15.1 onward in newest-first order", async () => {
    const fetchMock = vi.fn(async (url: string) => {
      ...
      if (url.endsWith("/commits/v1.26.3")) {
        return Response.json({
          commit: {
            author: { date: "2026-08-05T06:27:54Z" },
            message: "delivery: 2026-08-05 snapshot from 5bc2dbf47c33",
          },
        });
      }

      if (url.endsWith("/commits/v1.26.2")) {
        return Response.json({
          commit: {
            author: { date: "2026-08-02T09:59:47Z" },
            message: "delivery: 2026-08-02 snapshot from d8e51132715f",
          },
        });
      }
      ...
      if (url.endsWith("/commits/v1.25.0")) {
        return Response.json({
          commit: {
            author: { date: "2026-07-25T04:59:00Z" },
            message: "delivery: 2026-07-25 snapshot from e0d9fb180d27",
          },
        });
      }

      if (url.endsWith("/commits/v1.24.0")) {
        return Response.json({
          commit: {
            author: { date: "2026-07-19T05:36:28Z" },
            message: "delivery: 2026-07-19 snapshot from b7041b48fbd0",
          },
        });
      }

      if (url.endsWith("/commits/v1.23.2.preview")) {
        return Response.json({
          commit: {
            author: { date: "2026-07-14T10:30:23Z" },
            message: "delivery: 2026-07-14 snapshot from 4594ee6b2c82",
          },
        });
      }

      if (url.endsWith("/commits/v1.23.1.preview")) {
        return Response.json({
          commit: {
            author: { date: "2026-07-06T10:27:20Z" },
            message: "delivery: 2026-07-06 snapshot from 63df65d2d9f2",
          },
        });
      }

      if (url.endsWith("/commits/v1.23.0.preview")) {
        return Response.json({
          commit: {
            author: { date: "2026-07-01T12:05:47Z" },
            message: "delivery: 2026-07-01 snapshot from f946153cf7c5",
          },
        });
      }
      ...
      if (url.endsWith("/commits/v1.21.1.preview")) {
        return Response.json({
          commit: {
            author: { date: "2026-06-09T16:50:04Z" },
            message: "delivery: 2026-06-10 snapshot from 43c6a69c5234",
          },
        });
      }

      if (url.endsWith("/commits/v1.21.0.preview")) {
        return Response.json({
          commit: {
            author: { date: "2026-06-09T16:18:19Z" },
            message: "delivery: 2026-06-10 snapshot from 61e5e75542f3",
          },
        });
      }
      ...
      if (url.endsWith("/git/trees/v1.26.3?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agent-search/README.md", sha: "agent-search-readme-v1261", type: "blob" },
      ...
      if (url.endsWith("/git/trees/v1.26.2?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agent-search/README.md", sha: "agent-search-readme-v1261", type: "blob" },
            { path: "automation/agent-search/scheduler.ts", sha: "agent-search-scheduler-v1262", type: "blob" },
            { path: "automation/agent-search/routes.ts", sha: "agent-search-routes-v1262", type: "blob" },
            { path: "automation/agent-search/risk.ts", sha: "agent-search-risk-v1261", type: "blob" },
            { path: "automation/internal/server.ts", sha: "server-v1262", type: "blob" },
            { path: "src/pages/AgentSearchResults.tsx", sha: "agent-search-results-v1262", type: "blob" },
            { path: "automation/agent-search/run-lease.ts", sha: "agent-search-run-lease-v1262", type: "blob" },
            { path: "automation/agent-search/archive-generation.ts", sha: "agent-search-archive-generation-v1262", type: "blob" },
            { path: "automation/internal/global-permits.ts", sha: "automation-global-permits-v1262", type: "blob" },
            { path: "src/components/shared/AutoRefreshIndicator.tsx", sha: "auto-refresh-indicator-v1262", type: "blob" },
            { path: "supabase/migrations/20260717000100_agent_search_atomic_control.sql", sha: "agent-search-atomic-control-migration-v1262", type: "blob" },
            { path: "automation/agent-search/card-grid-cache.ts", sha: "agent-search-card-grid-cache-v1262", type: "blob" },
            { path: "automation/control/api-restart-admin-route.ts", sha: "api-restart-admin-route-v1262", type: "blob" },
            { path: "automation/internal/pending-health-breaker.ts", sha: "pending-health-breaker-v1262", type: "blob" },
            { path: "src/features/materials/lib/latestMaterialFile.ts", sha: "latest-material-file", type: "blob" },
      ...
      if (url.endsWith("/git/trees/v1.24.0?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agent-search/README.md", sha: "agent-search-readme-v1240", type: "blob" },
            { path: "automation/agent-search/scheduler.ts", sha: "agent-search-scheduler-v1240", type: "blob" },
            { path: "automation/agent-search/routes.ts", sha: "agent-search-routes-v1240", type: "blob" },
            { path: "automation/agent-search/risk.ts", sha: "agent-search-risk", type: "blob" },
            { path: "automation/internal/server.ts", sha: "server-v1240", type: "blob" },
            { path: "src/pages/AgentSearchResults.tsx", sha: "agent-search-results-v1240", type: "blob" },
            { path: "automation/agent-search/run-lease.ts", sha: "agent-search-run-lease", type: "blob" },
            { path: "automation/agent-search/archive-generation.ts", sha: "agent-search-archive-generation", type: "blob" },
            { path: "automation/internal/global-permits.ts", sha: "automation-global-permits", type: "blob" },
            { path: "src/components/shared/AutoRefreshIndicator.tsx", sha: "auto-refresh-indicator", type: "blob" },
            { path: "supabase/migrations/20260717000100_agent_search_atomic_control.sql", sha: "agent-search-atomic-control-migration", type: "blob" },
          ],
        });
      }

      if (url.endsWith("/git/trees/v1.23.2.preview?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agent-search/README.md", sha: "agent-search-readme-v1232", type: "blob" },
            { path: "automation/agent-search/scheduler.ts", sha: "agent-search-scheduler-v1232", type: "blob" },
            { path: "automation/agent-search/routes.ts", sha: "agent-search-routes-v1232", type: "blob" },
            { path: "automation/agent-search/risk.ts", sha: "agent-search-risk", type: "blob" },
            { path: "automation/agent-search/family-gates.ts", sha: "agent-search-family-gates", type: "blob" },
            { path: "automation/agent-search/card-grid.ts", sha: "agent-search-card-grid", type: "blob" },
            { path: "automation/internal/agent-search-api.test.ts", sha: "agent-search-api-test", type: "blob" },
            { path: "src/pages/AgentSearchResults.tsx", sha: "agent-search-results-v1232", type: "blob" },
            { path: "scripts/build-hermes-1688-v3-profile.sh", sha: "hermes-profile-build", type: "blob" },
            ...
            { path: "automation/fast-search/customer-eval-corpus.test.ts", sha: "customer-eval-corpus-v123", type: "blob" },
            ...
            { path: "automation/fast-search/standalone-flow/scripts/generate-search-intents.test.ts", sha: "standalone-intents-v123", type: "blob" },
            ...
            { path: "automation/internal/server.ts", sha: "server-v123", type: "blob" },
            ...
            { path: "src/pages/FastSearchResults.tsx", sha: "fast-search-results-v123", type: "blob" },
            ...
            { path: "supabase/migrations/20260624000100_agent_search.sql", sha: "agent-search-migration", type: "blob" },
            { path: "supabase/migrations/20260703000100_agent_search_risk_review.sql", sha: "agent-search-risk-migration", type: "blob" },
            { path: "automation/agent-search/artifact-policy.ts", sha: "agent-search-artifact-policy", type: "blob" },
            { path: "automation/agent-search/budgets.ts", sha: "agent-search-budgets", type: "blob" },
            { path: "automation/agent-search/recovery.ts", sha: "agent-search-recovery", type: "blob" },
            { path: "src/components/shared/AgentSearchMaterialPicker.tsx", sha: "agent-search-material-picker", type: "blob" },
            { path: "supabase/migrations/20260710000100_agent_search_optimization_contract.sql", sha: "agent-search-optimization-migration", type: "blob" },
          ],
        });
      }

      if (url.endsWith("/git/trees/v1.23.1.preview?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agent-search/README.md", sha: "agent-search-readme-v1231", type: "blob" },
            { path: "automation/agent-search/scheduler.ts", sha: "agent-search-scheduler-v1231", type: "blob" },
            { path: "automation/agent-search/routes.ts", sha: "agent-search-routes-v1231", type: "blob" },
            { path: "automation/agent-search/risk.ts", sha: "agent-search-risk", type: "blob" },
            { path: "automation/agent-search/family-gates.ts", sha: "agent-search-family-gates", type: "blob" },
            { path: "automation/agent-search/card-grid.ts", sha: "agent-search-card-grid", type: "blob" },
            { path: "automation/internal/agent-search-api.test.ts", sha: "agent-search-api-test", type: "blob" },
            { path: "src/pages/AgentSearchResults.tsx", sha: "agent-search-results-v1231", type: "blob" },
            { path: "scripts/build-hermes-1688-v3-profile.sh", sha: "hermes-profile-build", type: "blob" },
            { path: "automation/agentic-tools/web/research.ts", sha: "web-research", type: "blob" },
            { path: "automation/agentic-tools/web/web-tools.ts", sha: "web-tools-v121", type: "blob" },
            { path: "automation/fast-search/runtime.ts", sha: "fast-search-runtime", type: "blob" },
      ...
      if (url.endsWith("/git/trees/v1.23.0.preview?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agent-search/README.md", sha: "agent-search-readme", type: "blob" },
            { path: "automation/agent-search/scheduler.ts", sha: "agent-search-scheduler", type: "blob" },
            { path: "automation/agent-search/routes.ts", sha: "agent-search-routes", type: "blob" },
            { path: "automation/internal/agent-search-api.test.ts", sha: "agent-search-api-test", type: "blob" },
            { path: "src/pages/AgentSearchResults.tsx", sha: "agent-search-results", type: "blob" },
            { path: "automation/agentic-tools/web/research.ts", sha: "web-research", type: "blob" },
            { path: "automation/agentic-tools/web/web-tools.ts", sha: "web-tools-v121", type: "blob" },
            { path: "automation/fast-search/runtime.ts", sha: "fast-search-runtime", type: "blob" },
            { path: "automation/fast-search/persistence.ts", sha: "fast-search-persistence-v122", type: "blob" },
      ...
      if (url.endsWith("/git/trees/v1.21.1.preview?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agentic-tools/web/research.ts", sha: "web-research", type: "blob" },
            { path: "automation/agentic-tools/web/web-tools.ts", sha: "web-tools-v121", type: "blob" },
            { path: "automation/fast-search/runtime.ts", sha: "fast-search-runtime", type: "blob" },
            { path: "automation/fast-search/persistence.ts", sha: "fast-search-persistence", type: "blob" },
            { path: "automation/fast-search/standalone-flow/hermes-1688-skills-20260518-221929/productivity/1688-identify-product-keywords/SKILL.md", sha: "standalone-keywords-v1211", type: "blob" },
            { path: "automation/fast-search/standalone-flow/scripts/framework/skill-manifest.json", sha: "standalone-manifest-v1211", type: "blob" },
            { path: "automation/fast-search/standalone-flow/scripts/generate-search-intents.test.ts", sha: "standalone-intents-v1211", type: "blob" },
            { path: "automation/internal/api-auth-errors.ts", sha: "api-auth", type: "blob" },
            ...
            { path: "src/lib/pollingPolicy.ts", sha: "polling", type: "blob" },
            { path: "src/lib/visibleSelection.ts", sha: "visible-selection", type: "blob" },
            { path: "src/pages/FastSearchResults.tsx", sha: "fast-search-results", type: "blob" },
            { path: "src/services/searchService.ts", sha: "search-service-v120", type: "blob" },
            { path: "supabase/migrations/20260506.sql", sha: "migration", type: "blob" },
            { path: "supabase/migrations/20260508000100_optimize_supabase_egress.sql", sha: "egress", type: "blob" },
            { path: "supabase/migrations/20260511000100_optimize_search_read_paths.sql", sha: "search-read", type: "blob" },
      ...
      if (url.endsWith("/git/trees/v1.21.0.preview?recursive=1")) {
        return Response.json({
          truncated: false,
          tree: [
            { path: "automation/agentic-tools/web/research.ts", sha: "web-research", type: "blob" },
            ...
            { path: "automation/fast-search/runtime.ts", sha: "fast-search-runtime", type: "blob" },
            { path: "automation/fast-search/persistence.ts", sha: "fast-search-persistence", type: "blob" },
            { path: "automation/fast-search/standalone-flow/hermes-1688-skills-20260518-221929/productivity/1688-identify-product-keywords/SKILL.md", sha: "standalone-keywords-v1210", type: "blob" },
            { path: "automation/fast-search/standalone-flow/scripts/framework/skill-manifest.json", sha: "standalone-manifest-v1210", type: "blob" },
            { path: "automation/fast-search/standalone-flow/scripts/generate-search-intents.test.ts", sha: "standalone-intents-v1210", type: "blob" },
            { path: "automation/internal/api-auth-errors.ts", sha: "api-auth", type: "blob" },
            { path: "automation/internal/login-1688.js", sha: "login-v121", type: "blob" },
            { path: "automation/internal/server.ts", sha: "server-v120", type: "blob" },
            { path: "automation/internal/standardization-task-state.ts", sha: "standardization-task-state", type: "blob" },
    ...
    expect(allVersions[0]?.changelog.sections).toEqual([
      {
        title: "新增",
        items: [
          "Agent Search 商品卡复核新增“非驳回率（含未标记）”指标，与严格准确率并列展示，便于同时判断人工确认质量和候选可用覆盖。",
        ],
      },
      {
        title: "改进",
        items: [
          "未标记的候选商品卡进入复核面板后默认设为确认，并取消延迟自动保存，统一由“保存商品卡标记”显式批量提交，连续复核时状态更可控。",
          "精简 Agent Search 结果列表查询，不再随列表传输大块诊断数据；当前物料短缺改由请求数和结果数直接计算，降低大批量复核时的数据传输与渲染开销。",
        ],
      },
      {
        title: "修复",
        items: [
          "商品卡复核读取与批量审核现在只处理候选结果，避免历史或非候选记录混入复核网格并被错误标记。",
          "修复短暂并发写入保护迁移与显式保存语义不一致的问题；补充前向恢复迁移，使已应用中间版本的数据库回到明确的最后一次保存生效行为。",
        ],
      },
      {
        title: "运维 / 配置",
        items: [
          "同步 v1.26.3 客户 `.env` 配置；安装器会在每次安装时通过受保护的部署环境变量刷新共享环境文件。",
          "GitHub `releases/latest` 仍停留在 v1.24.0，安装服务继续以真实 tag 列表判定 v1.26.3 为最新交付版本。",
        ],
      },
      {
        title: "迁移与兼容性提示",
        items: [
          "本版本新增两项 Agent Search 批量审核函数迁移，升级时需按顺序应用；第二项兼容已应用短暂中间迁移的数据库，并恢复显式批量保存语义。",
